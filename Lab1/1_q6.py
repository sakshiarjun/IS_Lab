...
def affine_decrypt(ciphertext, key: tuple):
    a = key[0]
    b = key[1]
    decrypted_txt = ""
...
dec = affine_decrypt("XPALASXYFGFUKPXUSOGEUTKCDGEXANMGNVS",(5,6))
print(dec)

ciphertext = "XPALASXYFGFUKPXUSOGEUTKCDGEXANMGNVS"
plaintext_sample = "AB"  # From the given information, "ab" encodes to "GL"
